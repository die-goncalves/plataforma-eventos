...
export function Challenge() {
  ...
  return (
    <div
      className="flex h-screen max-w-[1440px] flex-1 flex-col mx-auto items-center scrollbar px-8 pb-8"
    ...
    >
      ...
      <article className="flex flex-1 w-full max-w-[55.5rem] flex-col gap-8">
        <header>
